...
# ==============================================================================
# CORRECTION CRITIQUE : La fonction doit accepter 'balance'
# ==============================================================================
def send_report(title: str, trades: List[Dict[str, Any]], balance: Optional[float]):
    """Calcule les stats et envoie un rapport, en incluant le solde."""
    stats = reporting.get_report_stats(trades)
    message = reporting.format_report_message(title, stats, balance)
    tg_send(message)

# --- Le reste du fichier est identique à la version stable et propre ---
