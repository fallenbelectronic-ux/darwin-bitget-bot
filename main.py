...
import trader
import notifier
# CORRECTION: Importation du nouveau fichier utils
import utils
...
def process_message(message: Dict):
    ...
    if text.startswith("/start"): notifier.send_main_menu(_paused)
    ...
    while True:
        try:
            ...
            for symbol in universe:
                # CORRECTION: Appel de la fonction depuis utils
            ...
            notifier.tg_send("⛔ Arrêt manuel."); break
