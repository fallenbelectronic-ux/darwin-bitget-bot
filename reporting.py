...
def get_report_stats(trades: List[Dict[str, Any]], days: int = 7) -> Dict[str, Any]:
    """Retourne les statistiques de performance sur la période désirée."""
